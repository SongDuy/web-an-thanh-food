                ...
                <div className="w-full h-[555px] grid grid-cols-11 bg-white rounded-md border">
                    ...
                    <div className="col-span-4 flex flex-col gap-5 px-4 py-3 rounded-r-md bg-gray-100">
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full mt-5 max-h-[365px] pr-3 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-200 scrollbar-thumb-rounded-full scrollbar-track-rounded-full">
                                <div className="w-full h-full flex flex-col gap-2.5 pb-5">
                                    <div className="w-full h-[52px] flex items-center justify-center px-3 py-3 bg-white border rounded shadow-sm">
