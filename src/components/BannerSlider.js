        ...
        <div className="relative w-full h-full flex items-center justify-center bg-black">
          ...
          >
            ...
            <button
              ...
              onMouseEnter={() => setIsPaused(true)}
              onMouseLeave={() => setIsPaused(false)}
              className="absolute left-4 top-1/2 -translate-y-1/2 z-30 w-8 h-14 rounded-md shadow bg-black/30 hover:bg-black text-white text-2xl flex items-center justify-center transition-all duration-300 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto"
            >
              <ArrowBackIosNewIcon />
            </button>
            ...
            <button
              ...
              onMouseEnter={() => setIsPaused(true)}
              onMouseLeave={() => setIsPaused(false)}
              className="absolute right-4 top-1/2 -translate-y-1/2 z-30 w-8 h-14 rounded-md shadow bg-black/30 hover:bg-black text-white text-2xl flex items-center justify-center transition-all duration-300 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto"
            >
              <ArrowForwardIosIcon />
            </button>
