                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative w-[70px] h-[70px] overflow-hidden rounded flex-shrink-0">
                                    ...
                                    <div className="absolute flex items-center top-0 right-0 bg-gradient-to-t from-red-50 via-red-100 to-red-100 shadow text-white text-shadow-black font-bold px-1 py-1 rounded-bl-[5px] z-10 leading-none">
