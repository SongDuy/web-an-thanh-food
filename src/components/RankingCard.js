        ...
        <div className="w-full h-[145px] rounded shadow bg-white border hover:bg-red-50 p-4">
          <div className="w-full h-full flex gap-3">
            <div className="flex items-center justify-center gap-3">
              ...
              <div className="min-w-[50px] h-[50px] bg-red-50 shadow text-black text-shadow-white font-serifBook rounded-full text-[35px] leading-none flex items-center justify-center">
                {index + 1}
              </div>
